...
{
    public class TequilaModel : PageModel
    {
        private readonly ApplicationDbContext _context;

        public TequilaModel(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            Products = await _context.Products.Where(p => p.CategoryId == 2).Select(p => new Product
            {
