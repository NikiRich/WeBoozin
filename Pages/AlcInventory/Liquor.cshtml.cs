...
{
    public class LiquorModel : PageModel
    {
        private readonly ApplicationDbContext _context;
        public LiquorModel(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            Products = await _context.Products.Where(p => p.CategoryId == 7).Select(p => new Product
            {
