...
{
    public class WineModel : PageModel
    {
        private readonly ApplicationDbContext _context;
        public WineModel(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            Products = await _context.Products.Where(p => p.CategoryId == 8).Select(p => new Product
            {
