...
{
    public class ChampagneModel : PageModel
    {
        private readonly ApplicationDbContext _context;

        public ChampagneModel(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            Products = await _context.Products.Where(p => p.CategoryId == 9).Select(p => new Product
            {
